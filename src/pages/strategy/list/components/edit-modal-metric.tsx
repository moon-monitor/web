...
import { DatasourceDriverMetric, GlobalStatus, StrategyType } from '@/api2/enum'
...
import { basicFormItems, metricDatasourceFormItems } from './options'
...
export default function MetricEditModal(props: MetricEditModalProps) {
  ...
  return (
    <Modal {...restProps} footer={null}>
      ...
      <div className='mt-10 h-30'>{steps[current].content}</div>
